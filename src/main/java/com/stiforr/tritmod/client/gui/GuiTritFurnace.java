...
public class GuiTritFurnace extends GuiContainer{

	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
	private TileEntityTritFurnace tileFurnace;

	public GuiTritFurnace(InventoryPlayer invPlayer, TileEntityTritFurnace tile) {
		super(new ContainerTritFurnace(invPlayer, tile));
