package com.stiforr.tritmod.inventory;

import com.stiforr.tritmod.handler.TritFurnaceRecipes;
...
public class ContainerTritFurnace extends Container {

	private TileEntityTritFurnace tileFurnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public ContainerTritFurnace(InventoryPlayer player, TileEntityTritFurnace tileEntityFurnace){
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				if(TritFurnaceRecipes.smelting().getSmeltingResult(itemstack1) != null){
					if(!this.mergeItemStack(itemstack1, 0, 1, false)){
						return null;
					}
				}else if(TileEntityTritFurnace.isItemFuel(itemstack1)){
